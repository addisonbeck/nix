...
- When an ADR affects an existing technical breakdown, flag it in output and coordinate with technical-breakdown-maintainer for breakdown update (dogfooding relationship: ADR --> breakdown synthesis)
