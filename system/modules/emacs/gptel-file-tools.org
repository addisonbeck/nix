...
(gptel-make-tool
 ...
 :description "Read entire file content and return in response. Prompts for confirmation before reading file contents. IMPORTANT: do not read files that you already have from Required Reading in memory!"
 :args '((:name "file_path" 
          :type string
...
#+RESULTS:
: #s(gptel-tool gptel-buffer-read-file "buffer_read_file" "Read entire file content and return in response. Prompts for confirmation before reading file contents. IMPORTANT: do not read files that you already have from Required Reading in memory!" ((:name "file_path" :type "string" :description "Path to the file to read") (:name "purpose" :type "string" :description "Required explanation of why this file read is being performed")) nil "file-reading" nil nil)
