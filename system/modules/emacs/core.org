...
(setq agent-shell-anthropic-claude-command "claude --agent bobert")

(setq agent-shell-mcp-servers
      '(((name . "org-roam")
         (command . "/Users/me/binwarden/addisonbeck-org-roam-mcp/main/result/bin/org-roam-mcp")
         (args . [])
         (env . [((name . "ORG_ROAM_DIR")
                  (value . "/Users/me/Library/Mobile Documents/com~apple~CloudDocs/notes/roam"))]))
        ((name . "filesystem")
         (command . "npx")
         (args . ["-y" "@modelcontextprotocol/server-filesystem"
                  "/tmp" "/Users/me/binwarden" "/Users/me/notes"])
         (env . []))
        ((name . "atlassian")
         (type . "sse")
