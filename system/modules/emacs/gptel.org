...
(use-package gptel
  ...
  (setq gptel--system-message "The LLM (you) is a helpful assistant integrated into emacs. The LLM's name is Bobert. Bobert always writes in org markup, using org source blocks when writing code. Bobert always speaks and thinks from a 3rd person point of view. Bobert NEVER says, thinks, or reasons words like \"I\" or \"me\" and only refers to themselves as \"Bobert\". Bobert is concise and thinks more than they act.")
...
(let ((token (plist-get auth :secret)))
  ...
  (gptel-make-anthropic "Claude: Think"
		  :stream t
		  :key (lambda () (my/get-api-key "api.anthropic.com"))
      :models '(claude-sonnet-4-5-20250929 claude-haiku-4-5-20251001 claude-opus-4-5-20251101)
      :request-params '(:thinking (:type "enabled" :budget_tokens 4000)
        :max_tokens 31999))

  (gptel-make-anthropic "Claude: Think Hard"
		  :stream t
		  :key (lambda () (my/get-api-key "api.anthropic.com"))
      :models '(claude-sonnet-4-5-20250929 claude-haiku-4-5-20251001 claude-opus-4-5-20251101)
  ...
  (gptel-make-anthropic "Claude: Think Harder"
		  :stream t
		  :key (lambda () (my/get-api-key "api.anthropic.com"))
      :models '(claude-sonnet-4-5-20250929 claude-haiku-4-5-20251001 claude-opus-4-5-20251101)
  ...
  (gptel-make-anthropic "Claude: Ultrathink"
		  :stream t
		  :key (lambda () (my/get-api-key "api.anthropic.com"))
      :models '(claude-sonnet-4-5-20250929 claude-haiku-4-5-20251001 claude-opus-4-5-20251101)
      :request-params '(:thinking (:type "enabled" :budget_tokens 30000)
        :max_tokens 31999))
...
(setq mcp-hub-servers
      `(
       ("filesystem" . (:command "npx"
        ...
        ("atlassian" . (:command "npx" :args ("-y" "mcp-remote" "https://mcp.atlassian.com/v1/sse" "--resource" "https://bitwarden.atlassian.net/")))
        ("github-mcp" . (:command "docker"
                        :args ("run" "-i" "--rm"
                              "-e" "GITHUB_PERSONAL_ACCESS_TOKEN"
                              "ghcr.io/github/github-mcp-server")
                       :env (:GITHUB_PERSONAL_ACCESS_TOKEN ,(my/get-github-mcp-token))))
        ("org-roam" . (:command "/Users/me/binwarden/addisonbeck-org-roam-mcp/main/result/bin/org-roam-mcp"
                                :args ()
                                :env (:ORG_ROAM_DIR "/Users/me/Library/Mobile Documents/com~apple~CloudDocs/notes/roam")))
