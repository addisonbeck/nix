...
Without a prefix, exports today's daily agenda.
With \\[universal-argument], exports a 7-day weekly view."
  (interactive "P")
  (require 'org-agenda)
      ...
      (let ((org-agenda-window-setup 'current-window)
        ...
        (let ((lines (split-string
          ...
          (with-temp-file tmp-org
            ...
            (dolist (line lines)
              (cond
               ;; Date headers like "Wednesday  25 March 2026"
               ((string-match-p "\\`[A-Z][a-z]+ +[0-9]" line)
                (insert "\n* " (string-trim line) "\n"))
               ;; Non-blank content → list items
               ((string-match-p "[^ \t]" line)
