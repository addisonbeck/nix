...
Defines the three-state TODO state machine for the Bobert agent dispatch loop.
State transitions: TODO -> IN_PROGRESS (watcher spawns Claude) -> DONE (clean exit) | TODO (error exit).
See ADR-016.
    ...
    (let* ((buf-name (my/agenda--buf-name-for-marker marker))
      ...
      (unless (get-buffer buf-name)
        (with-current-buffer (vterm buf-name)
          ...
          ;; At 3s: send down arrow to move selection from No to Yes.
          ;; At 3.5s: send Enter to confirm Yes.
