...
Write clearly. Think relationally. When creating a new node always output its id, title, and file path to the user"
 :args        '((:name "title"
                      :type string)
                 (:name "content"
                      :type string
...
(defun my/gptel-org-roam-node-content-by-id (id)
  "Return subtree content of an org-roam node by Roam ID."  
