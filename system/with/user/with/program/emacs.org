...
#+begin_src emacs-lisp
  (defun my/run-repomix (directory)
    ...
    (let* ((default-directory directory)
           ...
           (command "repomix analyze . --max-files 20 --max-file-size 25000 --exclude-patterns 'node_modules,dist,.git,*.min.js,*.bundle.js'"))
...
#+begin_src emacs-lisp
  (defun bitwarden/run-nx-poc-dekstop ()
