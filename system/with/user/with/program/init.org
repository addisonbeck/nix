...
#+begin_src emacs-lisp
  ...
  ;; Key bindings for path functions
  (global-set-key (kbd "C-c p f") 'copy-file-path)
  (global-set-key (kbd "C-c p n") 'copy-file-name)
  (global-set-key (kbd "C-c p d") 'copy-directory-path)
#+end_src
